...
# ================= SOUND =================
PUNCH_SFX = pygame.mixer.Sound(resource_path("BackgroundMusic/Rider_punch.wav"))
PUNCH_SFX.set_volume(1.0)

CYBORG_SFX = pygame.mixer.Sound(resource_path("BackgroundMusic/cyborg_punch.wav"))
...
# ================= BACKGROUND =================
base_surface = pygame.image.load(resource_path("Elements/Background.png")).convert()
resized_base = pygame.transform.scale(base_surface, (800, 400))
# ================= MENU POSTER =================
menu_bg = pygame.image.load(resource_path("Elements/MainMenu.png")).convert()
...
TUTORIAL_BGM = "BackgroundMusic/cyberpunk.mp3"
GAME_BGM = "BackgroundMusic/cyberpunk_main.mp3"

pygame.mixer.music.load(resource_path(TUTORIAL_BGM))
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_UP:
                    ...
                    if menu_options[menu_index] == "Controls":
                        ...
                        pygame.mixer.music.load(resource_path(GAME_BGM))
                        pygame.mixer.music.play(-1)
